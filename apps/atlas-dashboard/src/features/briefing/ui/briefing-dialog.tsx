...
import { useBriefing } from '@/features/briefing/model/use-briefing';
import { atlasDashboardPalette } from '@/shared/theme/atlas-theme';
import { monoFontFamily } from '@/shared/ui';
        ...
        <Flex vertical gap={24} style={{ padding: 32 }}>
              ...
              <Flex align="center" gap={14} vertical>
                <Spin
                  indicator={
                    <LoadingOutlined
                      spin
                      style={{ color: atlasDashboardPalette.core, fontSize: 28 }}
                    />
                  }
                />
          ...
          {!state.isLoading && state.error ? (
            <Alert
              ...
              showIcon
              style={{
                background: 'rgba(178, 74, 58, 0.14)',
                borderRadius: 20
              }}
              type="error"
            />
