...
export function renderHelpFooter(): string {
  return [
    ...
    `  ${APP_METADATA.cliName} up --with-image`,
    `  ${APP_METADATA.cliName} up --build --with-ai --with-image --with-workbench`,
    `  ${APP_METADATA.cliName} bootstrap --with-ai`,
    `  ${APP_METADATA.cliName} doctor --with-ai --with-image --smoke`,
    `  ${APP_METADATA.cliName} save-images --with-ai --with-image --with-workbench`,
    `  ${APP_METADATA.cliName} restore-images --input .\\backups\\images\\atlas-lab-images.tar.gz`,
    `  ${APP_METADATA.cliName} save-volumes --with-ai --with-image --with-workbench`,
